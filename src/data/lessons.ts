...
export const lessons: Record<ScenarioId, MiniLesson> = {
  'both-sides': {
    ...
    steps: [
      ...
      { title: '진입 각도 만들기', description: '주차 공간 반대 방향으로 핸들을 끝까지 돌려 전진합니다. 사이드미러에서 내 차 뒷부분이 주차 공간 중간쯤 오면 정지합니다.', cue: '양옆 차량과 앞부분의 회전 여유를 함께 확인하세요.', durationSeconds: 12, gear: 'D', steering: '좌측 끝까지', check: '양옆 차량 · 내 차 뒤 모서리의 위치' },
  ...
  'one-side': {
    ...
    steps: [
      ...
      { title: '진입 각도 만들기', description: '주차 반대 방향으로 핸들을 끝까지 돌려 전진하고 내 차 뒷부분이 주차 공간 중간에 오면 정지합니다.', cue: '회전하는 내 차 앞부분과 배치된 차량을 함께 확인하세요.', durationSeconds: 12, gear: 'D', steering: '좌측 끝까지', check: '배치 차량 · 내 차 뒤 모서리' },
  ...
  'wall-side': {
    ...
    steps: [
      ...
      { title: '진입 각도 만들기', description: '주차 공간 반대 방향으로 핸들을 끝까지 돌려 전진하고 내 차 뒷부분이 주차 공간 중간에 오면 정지합니다.', cue: '벽 반대편 차량과 내 차 뒤 범퍼의 여유를 기억하세요.', durationSeconds: 12, gear: 'D', steering: '좌측 끝까지', check: '벽 반대편 차량 · 내 차 뒤 모서리' },
