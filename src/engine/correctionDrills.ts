...
function buildEntryCorrectionCourse(
  ...
  const focusZone = kind === 'near'
    ? (leftEntry ? 'right-side' as const : 'left-side' as const)
    ...
    steps: [
      pathStep(
        ...
        [
          {
            id: 'keep-full-lock',
            label: '현재 조향을 그대로 유지하기',
            feedback: '현재 조향을 유지하면 다음 이동에서도 곡선이 이어져 새로운 위험을 만들 수 있습니다.',
            previewStates: [start],
            focusZone,
          },
          {
            id: 'countersteer',
            label: '핸들을 반대 방향으로 돌리기',
            feedback: '수정의 첫 단계는 반대 조향이 아니라 바퀴를 일자로 만드는 것입니다.',
            previewStates: [start, stopped(start, { steeringAngle: -turn })],
          },
        ],
      ...
      pathStep(
        ...
        `${kind === 'near' ? '가까운 쪽' : '먼 쪽'}이 좁을 때 어느 방향으로 움직일까요?`,
        space,
        pathChoice(
          `${kind}-space-answer`,
          moveLabel,
        ...
        [
          {
            id: 'wrong-direction',
            label: kind === 'near' ? '핸들을 중앙에 두고 D로 전진' : '핸들을 중앙에 두고 R로 후진',
          ...
          {
            id: 'turn-while-moving',
            label: `${moveGear}로 움직이며 반대 방향으로 조향`,
            feedback: '먼저 핸들을 중앙에 둔 채 움직여 공간을 만든 뒤 원래 방향으로 다시 조향해야 합니다.',
            motion: [{ gear: moveGear, steeringAngle: -turn, seconds: 1.2 }],
          },
        ],
    ...
    steps: [
      pathStep(
        ...
        [
          {
            id: 'sideways-reverse',
            label: `${correctionSide}으로 조향하고 R로 후진`,
            feedback: '현재 위치에서 후진 조향하면 뒤 모서리가 주차선과 옆 차량에 가까워집니다.',
            motion: [{ gear: 'R', steeringAngle: offsetReverseTurn, seconds: 1.5 }],
          },
          {
            id: 'early-turn',
            label: `${correctionSide}으로 조향하고 D로 전진`,
            feedback: '주차칸 안에서 먼저 꺾으면 앞 모서리의 회전 궤적이 옆 차량에 가까워질 수 있습니다.',
            motion: [{ gear: 'D', steeringAngle: offsetReverseTurn, seconds: 1.5 }],
          },
        ],
        ...
        [
          {
            id: 'straight-reverse',
            label: '핸들을 중앙에 두고 R로 후진',
            feedback: '평행 상태는 유지되지만 좌우 치우침도 그대로 남습니다.',
            motion: [{ gear: 'R', steeringAngle: 0, seconds: 2.6 }],
          },
          {
            id: 'keep-shift',
            label: `${correctionSide} 조향을 유지하고 R로 후진`,
            feedback: '중심선에 가까워진 뒤에는 반대 조향해야 차체가 평행해집니다.',
            motion: [{ gear: 'R', steeringAngle: offsetReverseTurn, seconds: 2.6 }],
          },
        ],
  ...
  const crooked: CorrectionDrill = {
    ...
    steps: [
        ...
        [
          {
            id: 'crooked-straight',
            label: '핸들을 중앙에 두고 R로 후진',
            feedback: '비스듬한 각도가 유지되어 좁은 쪽 선을 넘을 수 있습니다.',
            motion: [{ gear: 'R', steeringAngle: 0, seconds: 1.8 }],
          },
          {
            id: 'crooked-opposite',
            label: `${straightenSide === '오른쪽' ? '왼쪽' : '오른쪽'}으로 조향하고 D로 전진`,
            feedback: '차체가 기울어진 반대 방향이 아니라 더 기울어지는 방향으로 회전합니다.',
            motion: [{ gear: 'D', steeringAngle: -straightenTurn, seconds: 1.8 }],
          },
        ],
      ...
      pathStep(
        ...
        [
          {
            id: 'crooked-straight-back',
            label: '핸들을 중앙에 두고 R로 후진',
            feedback: '현재 위치가 중심에서 벗어나 있어 좌우 간격이 고르게 맞지 않습니다.',
            motion: [{ gear: 'R', steeringAngle: 0, seconds: 2.2 }],
          },
          {
            id: 'crooked-same-turn',
            label: `${reentrySide} 조향을 유지하고 R로 후진`,
            feedback: '중심선에 가까워진 뒤에는 반대 조향해야 차체가 평행해집니다.',
            motion: [{ gear: 'R', steeringAngle: crookedReverseTurn, seconds: 2.2 }],
          },
        ],
  ...
  return {
    ...
    steps: [
      pathStep(
        ...
        [
          {
            id: 'narrow-straight-forward',
            label: '핸들을 중앙에 두고 D로 전진',
            feedback: '직선 전진만으로는 다음 후진에 필요한 재진입각이 만들어지지 않습니다.',
            motion: [{ gear: 'D', steeringAngle: 0, seconds: 1.8 }],
          },
          {
            id: 'narrow-reverse-now',
            label: '현재 조향을 유지하고 R로 후진',
            feedback: '안쪽 간격이 충분히 회복되지 않아 같은 위험 지점으로 다시 접근합니다.',
            motion: [{ gear: 'R', steeringAngle: correction[0].steeringAngle, seconds: 1.5 }],
          },
        ],
        ...
        [
          {
            id: 'narrow-full-lock',
            label: '현재 조향을 유지하고 R로 후진',
            feedback: '평행에 가까워진 뒤에는 핸들을 풀어야 반대쪽 선으로 회전하지 않습니다.',
            motion: [{ gear: 'R', steeringAngle: finish[0].steeringAngle, seconds: 2.2 }],
          },
          {
            id: 'narrow-forward-again',
            label: '현재 조향을 유지하고 D로 전진',
            feedback: '현재는 후진으로 마무리할 공간이 확보되어 추가 전진이 필요하지 않습니다.',
            motion: [{ gear: 'D', steeringAngle: finish[0].steeringAngle, seconds: 1.5 }],
          },
        ],
